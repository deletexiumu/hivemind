...
- Example: `/dw:add-phase Add authentication` → description = "Add authentication"
- Example: `/dw:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /dw:add-phase <description>
Example: /dw:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /dw:plan-phase {N} to break down)
...
**Also available:**
- `/dw:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /dw:insert-phase)
- Don't create plans yet (that's /dw:plan-phase)
