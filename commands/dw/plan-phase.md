...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn dw-planner agent, verify plans with dw-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/dw:new-project` first.
...
```
Task(
  prompt="First, read ~/.claude/agents/dw-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
## 8. Spawn dw-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 HiveMind ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /dw:execute-phase
...
```
Task(
  prompt="First, read ~/.claude/agents/dw-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
## 10. Spawn dw-plan-checker Agent

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 HiveMind ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Spawn dw-planner with revision prompt:
...
- /dw:plan-phase {X} --research — re-research first
...
- [ ] dw-phase-researcher spawned if research needed
- [ ] Existing plans checked
- [ ] dw-planner spawned with context (including RESEARCH.md if available)
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] dw-plan-checker spawned (unless --skip-verify)
