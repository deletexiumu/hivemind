...
- Example: `/dw:remove-phase 17` → phase = 17
- Example: `/dw:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /dw:remove-phase <phase-number>
Example: /dw:remove-phase 17
```
...
To abandon current work, use /dw:pause-work instead.
```
...
Would you like to:
- `/dw:progress` — see updated roadmap status
