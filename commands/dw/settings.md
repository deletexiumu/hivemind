...
**If not found:** Error - run `/dw:new-project` first.
...
These settings apply to future /dw:plan-phase and /dw:execute-phase runs.

Quick commands:
- /dw:set-profile <profile> — switch model profile
- /dw:plan-phase --research — force research
- /dw:plan-phase --skip-research — skip research
- /dw:plan-phase --skip-verify — skip plan check
```
