...
**After this command:** Run `/dw:plan-phase [N]` to start execution.
</objective>

<execution_context>
@~/.claude/hivemind/references/questioning.md
@~/.claude/hivemind/references/ui-brand.md
@~/.claude/hivemind/templates/project.md
@~/.claude/hivemind/templates/requirements.md
</execution_context>
...
**Load milestone context (if exists, from /dw:discuss-milestone):**
...
- Check for MILESTONE-CONTEXT.md (from /dw:discuss-milestone)
...
Spawn 4 parallel dw-project-researcher agents with milestone-aware context:
...
Use template: ~/.claude/hivemind/templates/research-project/STACK.md
</output>
", subagent_type="dw-project-researcher", model="{researcher_model}", description="Stack research")
...
Use template: ~/.claude/hivemind/templates/research-project/FEATURES.md
</output>
", subagent_type="dw-project-researcher", model="{researcher_model}", description="Features research")
...
Use template: ~/.claude/hivemind/templates/research-project/ARCHITECTURE.md
</output>
", subagent_type="dw-project-researcher", model="{researcher_model}", description="Architecture research")
...
Use template: ~/.claude/hivemind/templates/research-project/PITFALLS.md
</output>
", subagent_type="dw-project-researcher", model="{researcher_model}", description="Pitfalls research")
```
...
Use template: ~/.claude/hivemind/templates/research-project/SUMMARY.md
Commit after writing.
</output>
", subagent_type="dw-research-synthesizer", model="{synthesizer_model}", description="Synthesize research")
```

Display research complete banner and key findings:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 HiveMind ► RESEARCH COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 HiveMind ► DEFINING REQUIREMENTS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Spawn dw-roadmapper agent with context:
...
", subagent_type="dw-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  ", subagent_type="dw-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 HiveMind ► MILESTONE INITIALIZED ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`/dw:discuss-phase [N]` — gather context and clarify approach
...
**Also available:**
- `/dw:plan-phase [N]` — skip discussion, plan directly
...
- [ ] dw-roadmapper spawned with phase numbering context
- [ ] Roadmap files written immediately (not draft)
- [ ] User feedback incorporated (if any)
- [ ] ROADMAP.md created with phases continuing from previous milestone
- [ ] All commits made (if planning docs committed)
- [ ] User knows next step is `/dw:discuss-phase [N]`
