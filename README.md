...
| 阶段 | 内容 | 状态 |
|------|------|------|
| Phase 1 | 基础架构：目录结构、命名规范、分层体系 | 待开始 |
| Phase 2 | 场景1-2：模型评审 + 模型设计 | 待开始 |
| Phase 3 | 场景3-4：SQL 生成 + 指标定义 | 待开始 |
| Phase 4 | 场景5-6：DQ 规则 + 血缘分析 | 待开始 |
| Phase 5 | 知识滚动：自动积累项目知识 | 待开始 |
| Phase 6 | 工具化：提示构建器、规格校验 | 待开始 |
| Phase 7 | 集成测试：端到端验证 | 待开始 |
| Phase 8 | 文档完善：使用手册、最佳实践 | 待开始 |
