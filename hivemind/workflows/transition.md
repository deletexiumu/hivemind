...
Exit skill and invoke SlashCommand("/dw:plan-phase [X+1]")
...
**Also available:**
- `/dw:discuss-phase [X+1]` — gather context first
- `/dw:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/dw:complete-milestone {version}")
