...
<required_reading>
@~/.claude/hivemind/references/verification-patterns.md
@~/.claude/hivemind/templates/verification-report.md
</required_reading>
...
<!-- Goal-backward derivation expertise is baked into the dw-verifier agent -->
</step>
...
See ~/.claude/hivemind/templates/verification-report.md for complete template.
</step>
