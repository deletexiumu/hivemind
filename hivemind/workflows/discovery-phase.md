...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /dw:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/hivemind/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/hivemind/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/hivemind/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/hivemind/templates/discovery.md
...
Use ~/.claude/hivemind/templates/discovery.md.
...
1. Discuss phase context (/dw:discuss-phase [current-phase])
2. Create phase plan (/dw:plan-phase [current-phase])
