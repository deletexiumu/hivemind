...
<task type="auto">
  ...
  <done>
    电商订单复杂案例创建完成，包含多维度 + SCD Type 2 场景的完整输入→输出示例
  </done>
</task>
...
<task type="auto">
  ...
  <done>
    财务收入中等案例创建完成，展示周期快照事实表场景，与事务事实表形成对比
  </done>
</task>
